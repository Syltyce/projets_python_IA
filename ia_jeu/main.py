...
from panda3d.core import DirectionalLight,AmbientLight,WindowProperties,CollisionTraverser,CollisionHandlerQueue,CollisionSphere,CollisionPolygon,LPoint3f,CollisionNode,CollisionBox
...
# On crée une class qui héritera des propriété de l'objet ShowBase fourni par Panda3D : 
# - Repère cartésien 
# - Un Task Managager 
# - Une caméra
# - Un loader (pour télécharger nos modèles 3D)
# - Une fenêtre de rendu (renderer)
class Game(ShowBase):
    def __init__(self):
    ...
    # On importe nos modèles 3D à l'ai du loader : la map et le pikachu
    def importModels(self):
        self.mapModel = self.loader.loadModel("map_tuto.glb")
        self.playerModel = self.loader.loadModel("pikachu.glb")
